...
import fi.liike.rest.Service.ToimintaprosessiService;
...
@Api(value = "Toimintaprosessi")
@Path("/toimintaprosessi/")
public class ToimintaprosessiController extends MainController {
    private final ToimintaprosessiService service;

    public ToimintaprosessiController() {
        service = new ToimintaprosessiService();
    }
    ...
    public Response create(@Context HttpServletRequest httpRequest, ToimintaprosessiDto content) {
    ...
    public Response create(HttpServletRequest httpRequest, ContentDto content) {
        return create(httpRequest, (ToimintaprosessiDto) content);
    }
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response update(@Context HttpServletRequest httpRequest, ToimintaprosessiDto content) {
    ...
    public Response update(HttpServletRequest httpRequest, ContentDto content) {
        return update(httpRequest, (ToimintaprosessiDto) content);
    }
