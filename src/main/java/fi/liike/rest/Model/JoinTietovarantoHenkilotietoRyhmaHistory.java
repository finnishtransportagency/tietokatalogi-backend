...
@Entity
@Table(name = "TIETOVARHENKTIETORYHMAHISTORIA")
public class JoinTietovarantoHenkilotietoRyhmaHistory extends JoinTietovarantoAttributeHistory implements JoinHistory, java.io.Serializable {
    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_gen")
    @SequenceGenerator(name = "seq_gen", sequenceName = "TIETOVARHENTIETRYHMHIST_ID_SEQ")
    ...
    public JoinTietovarantoHenkilotietoRyhmaHistory() {
    }

    public JoinTietovarantoHenkilotietoRyhmaHistory(Integer parentNode, String attribuuttiarvo) {
