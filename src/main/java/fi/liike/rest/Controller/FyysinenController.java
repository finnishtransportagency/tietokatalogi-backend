...
import fi.liike.rest.Service.FyysinenService;
...
@Api(value = "Fyysinen")
@Path("/fyysinen/")
public class FyysinenController extends MainController {

	private FyysinenService service;

	public FyysinenController() {
		service = new FyysinenService();
	}
	...
	public Response create(@Context HttpServletRequest httpRequest, FyysinenTietovarantoDto content) throws IOException {
	...
	public Response create(HttpServletRequest httpRequest, ContentDto content) throws IOException {
		return create(httpRequest, (FyysinenTietovarantoDto) content);
	}
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	public Response update(@Context HttpServletRequest httpRequest, FyysinenTietovarantoDto content) {
	...
	public Response update(HttpServletRequest httpRequest, ContentDto content) throws IOException {
		return update(httpRequest, (FyysinenTietovarantoDto) content);
	}
