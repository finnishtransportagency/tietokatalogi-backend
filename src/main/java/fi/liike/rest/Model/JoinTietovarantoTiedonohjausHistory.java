...
@Entity
@Table(name = "TIETOVARATIEDONOHJAUSHISTORIA")
public class JoinTietovarantoTiedonohjausHistory extends JoinTietovarantoAttributeHistory implements JoinHistory, java.io.Serializable {
    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_gen")
    @SequenceGenerator(name = "seq_gen", sequenceName = "TIETOVARATIEDONOHJSHIST_ID_SEQ")
    ...
    public JoinTietovarantoTiedonohjausHistory() {
    }

    public JoinTietovarantoTiedonohjausHistory(Integer parentNode, String attribuuttiarvo) {
