...
@Entity
@Table(name = "TIETOVARANTOYLLAPITOMUUTAHO")
public class JoinTietovarantoYllapitoMuuTaho extends JoinTietovarantoAttribute implements java.io.Serializable {
    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_gen")
    @SequenceGenerator(name = "seq_gen", sequenceName = "TIETOVARYLLAPITOMUUTAHO_ID_SEQ")
    ...
    @Column(name = "yllapito_muu_taho")
    private String attribuuttiarvo;

    public JoinTietovarantoYllapitoMuuTaho() {
    }

    public JoinTietovarantoYllapitoMuuTaho(Integer tietovarantotunnus, String attribuuttiarvo) {
    ...
    public boolean equals(Object o) {
        ...
        JoinTietovarantoYllapitoMuuTaho that = (JoinTietovarantoYllapitoMuuTaho) o;
