...
public class Organisaatio extends Haettava implements Serializable {
    private static final long serialVersionUID = 1L;
    public static final String seq_name = "organisaatio_id_seq";

    @Id
    @Column(name = "organisaatiotunnus", unique = true, nullable = false)
