...
@Entity
@Table(name = "TIETOVARAKASITTPERUSTEHISTORIA")
public class JoinTietovarantoKasittelynPerusteHistory extends JoinTietovarantoAttributeHistory implements JoinHistory, java.io.Serializable {
    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_gen")
    @SequenceGenerator(name = "seq_gen", sequenceName = "TIETOVARAKASITPERUSHIST_ID_SEQ")
    ...
    public JoinTietovarantoKasittelynPerusteHistory() {
    }

    public JoinTietovarantoKasittelynPerusteHistory(Integer parentNode, String attribuuttiarvo) {
