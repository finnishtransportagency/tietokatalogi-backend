...
@Entity
@Table(name = "HENKILO")
public class Henkilo implements Serializable, Cloneable {
    public static final String seqName = "henkilo_id_seq";
    public static final String idColumn = "TUNNUS";
    public static final String mergeMatchingColumn = "OBJECT_ID";
    ...
    public Henkilo(Integer tunnus, String objectID, String nayttonimi, String tunnustyyppi, Integer poistunut, String kayttajatunnus,
    ...
    public Henkilo(String objectID, String nayttonimi, String tunnustyyppi, Integer poistunut, String kayttajatunnus,
                   String yritys, String yritystunnus, String etunimi, String sukunimi, String sahkoposti, String matkapuhelin) {
        this.objectID = objectID;
        this.nayttonimi = nayttonimi;
        this.tunnustyyppi = tunnustyyppi;
    ...
    public static List<String> getUpdateColumnsForMerge() {
        return Arrays.asList("NAYTTONIMI", "TUNNUSTYYPPI", "POISTUNUT", "KAYTTAJATUNNUS", "YRITYS", "YRITYSTUNNUS",
                "ETUNIMI", "SUKUNIMI", "SAHKOPOSTI", "MATKAPUHELIN");
    }

    public static List<String> getInsertColumnsForMerge() {
        ArrayList<String> result = new ArrayList<String>(){};
        result.add(idColumn); result.add(mergeMatchingColumn);
