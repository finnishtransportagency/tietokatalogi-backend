...
@Entity
@Table(name = "TIETOVARATURVATOIMPIDEHISTORIA")
public class JoinTietovarantoTurvatoimenpideHistory extends JoinTietovarantoAttributeHistory implements JoinHistory, java.io.Serializable {
    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_gen")
    @SequenceGenerator(name = "seq_gen", sequenceName = "TIETOVARTURVTOIMPIDHIST_ID_SEQ")
    ...
    public JoinTietovarantoTurvatoimenpideHistory() {
    }

    public JoinTietovarantoTurvatoimenpideHistory(Integer parentNode, String attribuuttiarvo) {
