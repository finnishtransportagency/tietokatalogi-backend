...
@Entity
@Table(name = "TERMILOMAKEHIERARKKASITE")
public class TermilomakeJoinHierarkkinenKasite extends JoinTable implements java.io.Serializable {

    private static final long serialVersionUID = 1L;
    public static final String seq_name = "TERMILOMAKEHIERKASITE_ID_SEQ";
    ...
    public TermilomakeJoinHierarkkinenKasite() {}

    public TermilomakeJoinHierarkkinenKasite(Integer termilomakeTunnus, Integer parentNode) {
    ...
    public boolean equals(Object o) {
        ...
        TermilomakeJoinHierarkkinenKasite that =
                (TermilomakeJoinHierarkkinenKasite) o;
    ...
    public String toString() {
        return format("TermilomakeHierarkkinenYlakasiteDto [hierarkkinenYlakasite=%s, " +
                              "hierarkkinenAlakasite=%s, rivitunnus=%s",
