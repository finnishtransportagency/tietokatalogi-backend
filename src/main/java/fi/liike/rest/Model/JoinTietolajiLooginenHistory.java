...
@Entity
@Table(name = "tietolooginenhistoria")
public class JoinTietolajiLooginenHistory implements java.io.Serializable, JoinHistory {
	...
	@SequenceGenerator(name = "seq_gen", sequenceName = "jointietolooghistoria_id_seq")
	...
	public JoinTietolajiLooginenHistory() {
	}

	public JoinTietolajiLooginenHistory(int childNode) {
		this.childNode = childNode;
	}

	public JoinTietolajiLooginenHistory(int childNode, int parentNode) {
		this.childNode = childNode;
	...
	public String toString() {
		return "JoinLooginenFyysinen[childNode=" + childNode + ", parentNode=" + parentNode + ", historyType="
				+ historiatyyppi + "]";
	}
