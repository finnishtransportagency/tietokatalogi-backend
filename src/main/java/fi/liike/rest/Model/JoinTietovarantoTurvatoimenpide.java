...
@Entity
@Table(name = "TIETOVARANTOTURVATOIMENPIDE")
public class JoinTietovarantoTurvatoimenpide extends JoinTietovarantoAttribute implements java.io.Serializable {
    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_gen")
    @SequenceGenerator(name = "seq_gen", sequenceName = "TIETOVARTURVATOIMENPIDE_ID_SEQ")
    ...
    @Column(name = "turvatoimenpide")
    private String attribuuttiarvo;

    public JoinTietovarantoTurvatoimenpide() {
    }

    public JoinTietovarantoTurvatoimenpide(Integer tietovarantotunnus, String attribuuttiarvo) {
    ...
    public boolean equals(Object o) {
        ...
        JoinTietovarantoTurvatoimenpide that = (JoinTietovarantoTurvatoimenpide) o;
