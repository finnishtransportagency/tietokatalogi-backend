...
@Entity
@Table(name = "TIETOVARAYHTREKPITAJAHISTORIA")
public class JoinTietovarantoYhteisrekisterinpitajaHistory extends JoinTietovarantoAttributeHistory implements JoinHistory, java.io.Serializable {
    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_gen")
    @SequenceGenerator(name = "seq_gen", sequenceName = "TIETOVARAYHTREKPITAHIST_ID_SEQ")
    ...
    public JoinTietovarantoYhteisrekisterinpitajaHistory() {
    }

    public JoinTietovarantoYhteisrekisterinpitajaHistory(Integer parentNode, String attribuuttiarvo) {
