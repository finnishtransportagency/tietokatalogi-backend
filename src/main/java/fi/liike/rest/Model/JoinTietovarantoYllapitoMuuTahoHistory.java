...
@Entity
@Table(name = "TIETOVARAYLLAPITOTAHOHISTORIA")
public class JoinTietovarantoYllapitoMuuTahoHistory extends JoinTietovarantoAttributeHistory implements JoinHistory, java.io.Serializable {
    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_gen")
    @SequenceGenerator(name = "seq_gen", sequenceName = "TIETOVARAYLLAPTTAHOHIST_ID_SEQ")
    ...
    public JoinTietovarantoYllapitoMuuTahoHistory() {
    }

    public JoinTietovarantoYllapitoMuuTahoHistory(Integer parentNode, String attribuuttiarvo) {
