...
import fi.liike.rest.Service.PaatietoryhmaService;
import fi.liike.rest.api.ContentDto;
import fi.liike.rest.api.SearchContent;
import fi.liike.rest.api.dto.PaatietoryhmaDto;
import io.swagger.annotations.Api;

import java.io.IOException;

@Api(value = "Päätietoryhmä")
@Path("/paatietoryhma/")
public class PaatietoryhmaController extends MainController {

	private PaatietoryhmaService service;

	public PaatietoryhmaController() {
		service = new PaatietoryhmaService();
	}
	...
	public Response create(@Context HttpServletRequest httpRequest, PaatietoryhmaDto content) throws IOException {
	...
	public Response create(HttpServletRequest httpRequest, ContentDto content) throws IOException {
		return create(httpRequest, (PaatietoryhmaDto) content);
	}
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	public Response update(@Context HttpServletRequest httpRequest, PaatietoryhmaDto content) {
	...
	public Response update(HttpServletRequest httpRequest, ContentDto content) throws IOException {
		return update(httpRequest, (PaatietoryhmaDto) content);
	}
