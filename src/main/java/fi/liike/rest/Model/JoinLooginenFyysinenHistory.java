...
@Entity
@Table(name = "looginenfyysinenhistoria")
public class JoinLooginenFyysinenHistory implements java.io.Serializable, JoinHistory {
	...
	@SequenceGenerator(name = "seq_gen", sequenceName = "joinloogfyyshistoria_id_seq")
	...
	public JoinLooginenFyysinenHistory() {
	}

	public JoinLooginenFyysinenHistory(int childNode) {
		this.childNode = childNode;
	}

	public JoinLooginenFyysinenHistory(int childNode, int parentNode) {
		this.childNode = childNode;
