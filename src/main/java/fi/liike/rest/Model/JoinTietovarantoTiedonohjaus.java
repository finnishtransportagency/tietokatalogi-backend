...
@Entity
@Table(name = "TIETOVARANTOTIEDONOHJAUS")
public class JoinTietovarantoTiedonohjaus extends JoinTietovarantoAttribute implements java.io.Serializable {
    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_gen")
    @SequenceGenerator(name = "seq_gen", sequenceName = "TIETOVARTIEDONOHJAUS_ID_SEQ")
    ...
    @Column(name = "tiedonohjaussuunnitelma")
    private String attribuuttiarvo;

    public JoinTietovarantoTiedonohjaus() {
    }

    public JoinTietovarantoTiedonohjaus(Integer tietovarantotunnus, String attribuuttiarvo) {
    ...
    public boolean equals(Object o) {
        ...
        JoinTietovarantoTiedonohjaus that = (JoinTietovarantoTiedonohjaus) o;
