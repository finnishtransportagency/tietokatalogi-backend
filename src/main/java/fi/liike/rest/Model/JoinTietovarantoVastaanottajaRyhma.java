...
@Entity
@Table(name = "TIETOVARANTOVASTAANOTTAJARYHMA")
public class JoinTietovarantoVastaanottajaRyhma extends JoinTietovarantoAttribute implements java.io.Serializable {
    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_gen")
    @SequenceGenerator(name = "seq_gen", sequenceName = "TIETOVARVASTAANOTTRYHMA_ID_SEQ")
    ...
    @Column(name = "vastaanottajaryhma")
    private String attribuuttiarvo;

    public JoinTietovarantoVastaanottajaRyhma() {
    }

    public JoinTietovarantoVastaanottajaRyhma(Integer tietovarantotunnus, String attribuuttiarvo) {
    ...
    public boolean equals(Object o) {
        ...
        JoinTietovarantoVastaanottajaRyhma that = (JoinTietovarantoVastaanottajaRyhma) o;
