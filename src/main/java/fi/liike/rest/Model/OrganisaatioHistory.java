...
@Entity
@Table(name = "ORGANISAATIOHISTORIA")
public class OrganisaatioHistory implements Serializable, HaettavaHistory {

    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_gen")
    @SequenceGenerator(name = "seq_gen", sequenceName = "organisaatiohistoria_id_seq")
    ...
    @Column(name = "organisaatiotunnus")
