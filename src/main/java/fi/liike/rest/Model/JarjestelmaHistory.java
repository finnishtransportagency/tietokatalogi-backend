...
@Entity
@Table(name = "tietojarjestelmasalkkuhistoria")
public class JarjestelmaHistory implements Serializable, HaettavaHistory {
	...
	@SequenceGenerator(name = "seq_gen", sequenceName = "jarjestelmahist_id_seq")
	...
	@Column(name = "JARJ_OMISTAJA")
	private String jarj_omistaja;
	...
	public String toString() {
		return "JarjestelmaHistory [tunnus=" + tunnus + ", nimi=" + nimi + "]";
	}
	...
	public String getJarj_omistaja() {
		return jarj_omistaja;
	}

	public void setJarj_omistaja(String jarj_omistaja) {
		this.jarj_omistaja = jarj_omistaja;
	}
