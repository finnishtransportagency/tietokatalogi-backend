...
@Entity
@Table(name = "tietotietoryhmahistoria")
public class JoinTietolajiTietoryhmaHistory implements java.io.Serializable, JoinHistory {
	...
	@SequenceGenerator(name = "seq_gen", sequenceName = "jtietotietoryhmahist_id_seq")
	...
	public JoinTietolajiTietoryhmaHistory() {
	}

	public JoinTietolajiTietoryhmaHistory(int childNode) {
		this.childNode = childNode;
	}

	public JoinTietolajiTietoryhmaHistory(int childNode, int parentNode) {
		this.childNode = childNode;
	...
	public String toString() {
		return "JoinTietolajiTietoryhmaHistory[childNode=" + childNode + ", parentNode=" + parentNode + ", historyType="
				+ historiatyyppi + "]";
	}
