...
@Entity
@Table(name = "TIETOVARAVASTAANORYHMAHISTORIA")
public class JoinTietovarantoVastaanottajaRyhmaHistory extends JoinTietovarantoAttributeHistory implements JoinHistory, java.io.Serializable {
    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_gen")
    @SequenceGenerator(name = "seq_gen", sequenceName = "TIETOVARAVASTARYHMAHIST_ID_SEQ")
    ...
    public JoinTietovarantoVastaanottajaRyhmaHistory() {
    }

    public JoinTietovarantoVastaanottajaRyhmaHistory(Integer parentNode, String attribuuttiarvo) {
