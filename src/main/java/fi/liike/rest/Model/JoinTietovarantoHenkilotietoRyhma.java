...
@Entity
@Table(name = "TIETOVARANTOHENKILOTIETORYHMA")
public class JoinTietovarantoHenkilotietoRyhma extends JoinTietovarantoAttribute implements java.io.Serializable {
    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_gen")
    @SequenceGenerator(name = "seq_gen", sequenceName = "TIETOVARAHENKTIETORYHMA_ID_SEQ")
    ...
    @Column(name = "henkilotietoryhma")
    private String attribuuttiarvo;

    public JoinTietovarantoHenkilotietoRyhma() {
    }

    public JoinTietovarantoHenkilotietoRyhma(Integer parentNode, String attribuuttiarvo) {
    ...
    public boolean equals(Object o) {
        ...
        JoinTietovarantoHenkilotietoRyhma that = (JoinTietovarantoHenkilotietoRyhma) o;
