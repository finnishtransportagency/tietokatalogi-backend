...
import fi.liike.rest.Service.LooginenService;
...
@Api(value = "Looginen")
@Path("/looginen/")
public class LooginenController extends MainController {

	private LooginenService service;

	public LooginenController() {
		service = new LooginenService();
	}
	...
	public Response create(@Context HttpServletRequest httpRequest, LooginenTietovarantoDto content) throws IOException {
	...
	public Response create(HttpServletRequest httpRequest, ContentDto content) throws IOException {
		return create(httpRequest, (LooginenTietovarantoDto) content);
	}
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	public Response update(@Context HttpServletRequest httpRequest, LooginenTietovarantoDto content) {
	...
	public Response update(HttpServletRequest httpRequest, ContentDto content) throws IOException {
		return update(httpRequest, (LooginenTietovarantoDto) content);
	}
